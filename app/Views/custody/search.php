...
<div class="bg-white rounded-lg shadow-sm border border-gray-200">
    ...
    <div class="p-6">
        ...
        <?php if (!empty($_GET['q'])): ?>
            <p class="text-gray-600 mb-3">Showing results for: <strong>"<?= htmlspecialchars($_GET['q']) ?>"</strong></p>
        <?php endif; ?>
            ...
            <table class="w-full text-sm border border-gray-200">
                ...
                <tbody>
                    <?php if (empty($custodians)): ?>
                        <tr><td colspan="6" class="text-center py-4 text-gray-500">No custodians found matching your search.</td></tr>
                    <?php else: ?>
                        <?php $i = 1; foreach ($custodians as $c): ?>
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2"><?= htmlspecialchars($c['office_name'] ?? 'N/A') ?></td>
