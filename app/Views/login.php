...
<body class="bg-gradient-to-br from-[#182919] via-[#243C25] to-[#345635] min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-10 hover:shadow-[0_20px_60px_rgba(0,0,0,0.5)] transition-shadow duration-300 border border-white/10">
            ...
            <div class="flex items-center gap-3 my-4">
                <div class="flex-1 h-px bg-gradient-to-r from-transparent to-[#D1EEB8]"></div>
                <div class="w-2 h-2 bg-yellow-400 rounded-full shadow-[0_0_0_3px_rgba(251,191,36,0.25)]"></div>
                <div class="flex-1 h-px bg-gradient-to-l from-transparent to-[#D1EEB8]"></div>
            </div>
            ...
            <form method="POST" action="index.php">
                <div class="space-y-5">
                    ...
                    <button type="submit" name="login"
                            class="w-full py-3.5 bg-gradient-to-r from-yellow-400 to-amber-500 text-[#022E23] font-bold text-lg rounded-xl shadow-md hover:scale-[1.02] hover:shadow-lg transition-all duration-200">
