...
<?php endif; ?>
<form method="POST" action="index.php?page=users&sub=save" id="userForm">
    <?php if ($isEdit): ?>
    ...
    <div class="mt-4 border-t border-gray-200 pt-4">
        ...
        <div class="flex gap-4">
            <label class="inline-flex items-center">
                <input type="radio" name="new_personnel" value="0" checked class="w-4 h-4 text-green-600 border-gray-300 focus:ring-green-500">
                <span class="ml-2 text-sm text-gray-700">Select existing personnel</span>
            </label>
            <label class="inline-flex items-center">
                <input type="radio" name="new_personnel" value="1" class="w-4 h-4 text-green-600 border-gray-300 focus:ring-green-500">
