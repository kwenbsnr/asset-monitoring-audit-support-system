                        ...
                        <?php $i = 1 + (($page - 1) * 20); foreach ($custodians as $c): ?>
                            <tr class="border-b hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 text-center">
                                    <a href="index.php?page=assets&sub=by_office&office_id=<?= $officeId ?>&custodian_id=<?= $c['personnel_id'] ?>" class="px-3 py-1.5 text-sm bg-blue-600 text-white rounded hover:bg-blue-700"><i class="bi bi-eye"></i> View Assets</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
